 ...
 * @version 3/5/16
 */
public class MediaLib extends MySong
{
    public static void main()
    {
        ...
        MediaFile.writeString(song1.getTitle() + "(" + song1.getRating() + ")\n" + song2.getTitle() + "(" + song2.getRating() + ")\n" + song3.getTitle() + "(" + song3.getRating() + ")\n" + song4.getTitle() + "(" + song4.getRating() + ")\n" + song5.getTitle() + "(" + song5.getRating() + ")\n" + song6.getTitle() + "(" + song6.getRating() + ")\n" + song7.getTitle() + "(" + song7.getRating() + ")\n" + song8.getTitle() + "(" + song8.getRating() + ")\n" + song9.getTitle() + "(" + song9.getRating() + ")\n" + song10.getTitle() + "(" + song10.getRating() + ")\n");
