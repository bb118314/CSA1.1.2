...
public class SciFiName   
{
    ...
    public static void main()
    {
        ...
        int diceRoll = (int)(Math.random() * relativeName1.length()) + 1;
        int diceRoll2 = (int)(Math.random() * relativeName2.length()) + 1;
        
        System.out.println(relativeName1.substring(diceRoll, relativeName1.length()));
        System.out.println("Hello " + firstName.substring(0, 3) + lastName.substring(0, 2)
         + " " + city.substring(0, 2) + school.substring(0, 3) + " of " + relativeName1.substring(diceRoll, relativeName1.length())
         + relativeName2.substring(diceRoll2, relativeName2.length()) + ". Welcome!");
